...
class MySceneGraph {
    ...
    constructor(filename, scene) {
        ...
        this.scene = scene;
        //this.scene.XMLScenes.push(this);
        scene.graph = this;
    ...
    for (var i = 0; i < children.length; i++) {
        ...
        for (var k = 0; k < descendantsNodeNames.length; k++){
            if (descendantsNodeNames[k].nodeName == "noderef"){
                ...
                var descendantType = this.reader.getString(descendantsNodeNames[k], 'type', ['triangle', 'rectangle', 'cylinder', 'sphere', 'torus', 'spriteAnim', 'spriteText', 'plane', 'patch', 'board']);
